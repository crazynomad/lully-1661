...
| What                  | ID / URL                                                                                            |
|-----------------------|-----------------------------------------------------------------------------------------------------|
| Drive folder          | [`Lully · Labels`](https://drive.google.com/drive/folders/1md9TD3Kf9Ubu67dEFv_aAkCpoXxmEeX-)                |
| Source Sheet          | [`Lully · Plano de etiquetas`](https://docs.google.com/spreadsheets/d/1R6GdQlBbDjZ4ybabvpkpbFiocABH1OJnk4raihuohB0/edit) |
| Folder ID (env var)   | `1md9TD3Kf9Ubu67dEFv_aAkCpoXxmEeX-`                                                                   |
| Sheet ID (env var)    | `1R6GdQlBbDjZ4ybabvpkpbFiocABH1OJnk4raihuohB0`                                                        |
...
[`Settings → Secrets and variables → Actions → New repository secret`](https://github.com/crazynomad/lullly-1661/settings/secrets/actions/new):
...
| `LULLY_DRIVE_FOLDER_ID`      | `1md9TD3Kf9Ubu67dEFv_aAkCpoXxmEeX-`                  |
